Interactive Character with p5.js

This project features an interactive scene and character created using p5.js. The user can draw small circles on the canvas by moving the mouse, and clicking the mouse will redraw the scene.
